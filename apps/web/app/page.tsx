  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <nav className="flex items-center justify-between px-4 sm:px-8 py-4 sm:py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2 font-mono font-semibold text-sm sm:text-base">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 pt-10 sm:pt-14 pb-12 sm:pb-16">
        <h1 className="font-sans text-3xl sm:text-4xl md:text-5xl font-semibold leading-tight max-w-2xl tracking-tight">
          Bad tool calls fix themselves before your code sees them.
        </h1>
        <p className="mt-3 sm:mt-4 text-sm sm:text-base text-neutral-400 max-w-2xl">
        ...
        <div className="mt-5 sm:mt-6 flex items-center gap-2 rounded-lg border border-neutral-800 bg-neutral-950 pl-3 sm:pl-4 pr-2 py-2 font-mono text-xs sm:text-sm w-fit">
        ...
        <Card className="mt-8 sm:mt-12 border-neutral-800 bg-neutral-900 p-1">
          <div className="rounded-md bg-black p-4 sm:p-6 font-mono text-xs sm:text-sm">
            <div className="flex items-center justify-between text-neutral-500 text-[10px] sm:text-xs mb-3 sm:mb-4">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-12 sm:py-16 grid md:grid-cols-2 gap-8 sm:gap-10 items-center">
        <div>
          ...
          <ul className="mt-4 sm:mt-5 space-y-2 text-xs sm:text-sm text-neutral-400">
        ...
        <Card className="border-neutral-800 bg-neutral-900 p-4 sm:p-5 font-mono text-xs sm:text-sm">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-12 sm:py-16 grid md:grid-cols-2 gap-8 sm:gap-10 items-center">
        <Card className="border-neutral-800 bg-neutral-900 p-4 sm:p-5 font-mono text-xs sm:text-sm order-2 md:order-1">
          <p className="text-neutral-500 text-[10px] sm:text-xs mb-2 sm:mb-3">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-12 sm:py-16">
        <h2 className="font-sans text-xl sm:text-2xl font-semibold tracking-tight mb-2">
          Built for agent workflows.
        </h2>
        <p className="text-sm sm:text-base text-neutral-400 max-w-2xl mb-6 sm:mb-10">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={f.n}>
              <p className="text-[10px] sm:text-xs text-neutral-600 font-mono mb-2 sm:mb-3">
                {f.n}
              </p>
              <h3 className="text-sm sm:text-base font-semibold mb-1.5">
                {f.title}
              </h3>
              <p className="text-xs sm:text-sm text-neutral-400">{f.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <footer className="max-w-7xl mx-auto px-4 sm:px-8 py-10 sm:py-14">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 text-xs sm:text-sm mb-8 sm:mb-10">
          <div className="col-span-2 sm:col-span-1">
            <p className="font-mono font-semibold mb-1 sm:mb-2">callcheck</p>
          ...
          <div>
            <p className="text-neutral-600 text-[10px] sm:text-xs mb-2 sm:mb-3 tracking-wide">
              USAGE
            </p>
            <div className="space-y-1.5 sm:space-y-2 font-mono text-neutral-400 text-xs sm:text-sm">
              <p>callcheck check</p>
          ...
          <div>
            ...
            <div className="space-y-1.5 sm:space-y-2 text-neutral-400 text-xs sm:text-sm">
